...
replaceInFile("src/app/expense/[id].tsx", [
  {
    old: 'import { ScrollView, View, Text } from "react-native";',
    new: 'import { ScrollView, View } from "react-native";',
  },
  {
    old: 'Typography type="h3">"Untitled Expense"</Typography>',
    new: 'Typography type="h3">&quot;Untitled Expense&quot;</Typography>',
  },
]);

replaceInFile("src/app/expense/new.tsx", [
  {
    old: 'import type { User, GroupMember, Group } from "@/types";',
    new: 'import type { Group } from "@/types";',
  },
]);

replaceInFile("src/app/group/[id]/settle.tsx", [
  {
    old: 'import { Alert, Button, Typography, PressableFeedback } from "heroui-native";',
    new: 'import { Button, Typography, PressableFeedback } from "heroui-native";',
  },
...
replaceInFile("src/components/GroupCard.tsx", [
  {
    old: 'import { Typography, PressableFeedback, Chip } from "heroui-native";',
    new: 'import { Typography, PressableFeedback } from "heroui-native";',
  },
]);
