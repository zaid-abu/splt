...
export default function InviteRedemptionScreen() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      queueMicrotask(() => {
        if (active) setState({ phase: "error", message: "No invite token provided." });
      });
      return () => {
        active = false;
      };
    ...
    invitationsApi
      .resolveFriendInvite(token)
      .then((resolution) => {
        if (active) setState({ phase: "resolved", resolution });
      })
      .catch((err: unknown) => {
        if (!active) return;
        setState({
  ...
  const renderBody = () => {
    switch (state.phase) {
        ...
        return (
          <View style={{ alignItems: "center", paddingVertical: 48 }}>
            <ActivityIndicator
              size="large"
              color={coral.accent}
              accessibilityLabel="Resolving invite"
            />
            <Text
              style={{
        ...
        return (
          <View style={{ alignItems: "center", paddingVertical: 48 }}>
            <ActivityIndicator
              size="large"
              color={coral.accent}
              accessibilityLabel="Accepting invite"
            />
            <Text
              style={{
                fontFamily: "InstrumentSans_400Regular",
      ...
      case "redeemed":
        return (
          <View
            style={{ gap: 12, alignItems: "center", paddingVertical: 32, paddingHorizontal: 24 }}
          >
            <Text
              style={{
                fontFamily: "InstrumentSans_600SemiBold",
      ...
      case "error":
        return (
          <View
            style={{ gap: 16, alignItems: "center", paddingVertical: 32, paddingHorizontal: 24 }}
          >
            <Text
              style={{
                fontFamily: "InstrumentSans_600SemiBold",
