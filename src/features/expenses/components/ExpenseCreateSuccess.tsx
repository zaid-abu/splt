  ...
  return (
    <View style={{ flex: 1, paddingTop: 24 }}>
      ...
      >
        ...
        >
          <Text style={{ fontSize: 28, color: coral.positive }}>✓</Text>
        </View>
        <Text
          style={{
      ...
      >
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          >
            {formatAmount(yourShareMinor, currency)}
          </Text>
        </View>
        ...
        {youLentMinor > 0 && (
          <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
            ...
            >
              {formatAmount(youLentMinor, currency)}
            </Text>
          </View>
        )}
        ...
        {youBorrowedMinor > 0 && (
          <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
            ...
            >
              {formatAmount(youBorrowedMinor, currency)}
            </Text>
          </View>
        )}
      </View>
