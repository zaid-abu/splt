  ...
  return (
    <View className="gap-2">
      ...
      <Pressable
        ...
        className="bg-white h-[56px] rounded-[20px] px-4 flex-row items-center justify-between border border-border"
      >
      ...
      >
        <View className="flex-1 px-6 pt-2 pb-6">
          ...
          <View className="bg-white h-[44px] rounded-[16px] px-4 flex-row items-center mb-4 border border-border">
