...
- React Hook Form
- Zod
*(Do not introduce Redux, MobX, or unnecessary libraries).*
...
- *Rules:* Never fetch Supabase directly inside screen components. Never duplicate server state.
...
*Only optimize when measurable. Do not prematurely optimize.*
...
*Animations should feel subtle and polished. Never animate everything.*
