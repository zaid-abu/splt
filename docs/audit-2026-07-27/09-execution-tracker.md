...
| 2026-07-27 | Codex | P1-01       | Bypass the P0 exit dependency at the user's direction; define money transport, authorization, split authority, and reversal/audit semantics before financial SQL changes. | Design accepted in `docs/superpowers/specs/2026-07-27-p1-ledger-hardening-design.md`; next step is spec self-review and implementation planning.                                                       |
