...
| P0-11 | IN_PROGRESS | P0-09                   | Perform baseline iOS and Android walkthroughs for every live primary route; record screen, action, state, accessibility, and data defects as `DISC-*` rows.                                                                                   | Evidence links to device/build/OS notes and captures                                                 |
...
| 2026-07-27 | Codex | P0-11       | Capture native iOS/Android route walkthrough evidence and classify product/accessibility defects.                       | In progress; requires a runnable native target.                                                                                                                                                        |
